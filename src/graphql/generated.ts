...
export type AddressParent = Client;

export type AddressParentConnectInput = {
  Client?: InputMaybe<ClientConnectInput>;
};

export type AddressParentCreateInput = {
  Client?: InputMaybe<ClientCreateInput>;
};
...
export type AddressParentUpdateInput = {
  Client?: InputMaybe<ClientUpdateInput>;
};
...
export type AddressParentUpdateManyWithNestedWhereInput = {
  Client?: InputMaybe<ClientUpdateManyWithNestedWhereInput>;
};
...
export type AddressParentUpdateWithNestedWhereUniqueInput = {
  Client?: InputMaybe<ClientUpdateWithNestedWhereUniqueInput>;
};

export type AddressParentUpsertWithNestedWhereUniqueInput = {
  Client?: InputMaybe<ClientUpsertWithNestedWhereUniqueInput>;
};
...
export type AddressParentWhereUniqueInput = {
  Client?: InputMaybe<ClientWhereUniqueInput>;
};
...
export const CreateClientDocument = gql`
  ...
  createClient(data: {name: $name, phoneNumber: $phoneNumber}) {
    id
  }
}
    `;
